...
/**
  ...
  *
  * @checksum - 72dd5b2fa74629d0cad759977e9cff4b917e71284817d06895abbafca3bff8bc
  * @variables - radius=rounded-lg,accentColor=violet,colorTemperature=zinc,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
